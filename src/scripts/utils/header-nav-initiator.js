const HeaderNavInitiator = {
  ...
  _handleTrapFocus(event) {
    const focusableElem = document.querySelectorAll('.nav__list [href]:not([disabled])');
    const firstFocusableElem = document.querySelector('.nav__toggle');
...
export default HeaderNavInitiator;
